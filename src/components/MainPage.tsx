            ...
            <article className="flex-1 group rounded-[2rem] border border-white/10 bg-[#12131a] p-8 hover:bg-[#161720] transition-all duration-300 w-full overflow-hidden relative shadow-lg">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 leading-relaxed font-light">
                  Aegis-3는 클라우드 네이티브 환경에서 Shadow API를 공격 유인용으로 역이용하여 기업의 자산을 보호하고, 트래픽을 지능적으로 관리하는 SaaS형 차세대 API 보안 솔루션입니다. 직관적인 통합 대시보드를 통해 관리자가 위협 상황을 실시간으로 감시하고 전체 API 생태계를 한눈에 파악하며 완벽하게 통제할 수 있는 환경을 제공합니다.
                </p>
              </div>
            </article>
            <article className="flex-1 group rounded-[2rem] border border-white/10 bg-[#12131a] p-8 hover:bg-[#161720] transition-all duration-300 w-full overflow-hidden relative shadow-lg">
